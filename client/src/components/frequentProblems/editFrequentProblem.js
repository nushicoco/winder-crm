...
import { FormGroup, FormControl, ControlLabel, Button, Modal, DropdownButton, MenuItem } from 'react-bootstrap'
...
export default class EditFrequentProblem extends React.Component {
  ...
  renderForm () {
    const controls = this.props.fields.map(this.renderControl.bind(this))
